...
export default function StaffCallsPage() {
  ...
  const visibleCalls = activeTab === "WAITING" ? waitingCalls : acceptedCalls;
  ...
  return (
    <div className="min-h-full bg-[#0f172a] px-4 py-5 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-2 gap-3 sm:min-w-[260px]">
              <div className="rounded-2xl border border-slate-700 bg-slate-900/60 p-4">
                <div className="flex items-center gap-2 text-slate-500">
                  <Inbox size={16} />
                  <span className="text-xs font-bold">현재 호출</span>
                </div>
              ...
              <div className="rounded-2xl border border-slate-700 bg-slate-900/60 p-4">
                <div className="flex items-center gap-2 text-slate-500">
                  <Layers size={16} />
                  <span className="text-xs font-bold">수락 완료</span>
                </div>
                <p className="mt-2 text-3xl font-black text-white">
        ...
        <div className="sticky top-20 z-20 mb-5 grid grid-cols-2 gap-2 rounded-2xl border border-slate-800 bg-slate-950/90 p-1 backdrop-blur">
          <button
            type="button"
        ...
        <section className="rounded-3xl border border-slate-800 bg-[#1e293b]/70 p-4 sm:p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="hidden items-center gap-2 rounded-full border border-slate-700 bg-slate-900 px-3 py-2 text-xs font-black text-slate-400 sm:flex">
              <CircleDot size={12} />
